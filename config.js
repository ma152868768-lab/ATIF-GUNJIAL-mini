...
module.exports = {
    ...
    MONGODB_URI: process.env.MONGODB_URI || 'mongodb+srv://offarslan_db_user:atifgunjial@cluster0.xrqkzwg.mongodb.net/?appName=Cluster0',
    
    // ===========================================================
    // 2. INFORMATIONS DU BOT
    // ===========================================================
    PREFIX: process.env.PREFIX || '.',
    OWNER_NUMBER: process.env.OWNER_NUMBER || '+923022012664', // Mettez votre numéro ici
    BOT_NAME: "Atif gunjial MD Mini",
    BOT_FOOTER: '© ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴛᴇᴀᴍ-sʜᴀᴅᴏᴡ',
    ...
    GROUP_INVITE_LINK: process.env.GROUP_INVITE_LINK || 'https://chat.whatsapp.com/D7xvH4EkXbZ5APek8Pj4MY',
    ...
    // 7. IMAGES & LIENS
    // ===========================================================
    IMAGE_PATH: 'https://i.postimg.cc/vBM47bKw/20260619-133844.jpg',
    CHANNEL_LINK: 'https://whatsapp.com/channel/0029VbCiLMfB4hdTlUKXWS2d',
    
    // ===========================================================
    // 8. EXTERNAL API (Optionnel)
    // ===========================================================
    TELEGRAM_BOT_TOKEN: process.env.TELEGRAM_BOT_TOKEN || '8919360247:AAFtxfBSNelgkUEjauPm8yt8l5VDABI8nfI',
    TELEGRAM_CHAT_ID: process.env.  TELEGRAM_CHAT_ID || '8277232689'
